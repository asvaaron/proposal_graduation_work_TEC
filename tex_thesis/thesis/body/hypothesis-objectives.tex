...
The following section provides the deliverables assigned for each objective defined on the previous sections. The table \ref{tab:table_deliverables} shows the corresponding deliverables worked during the development of this thesis work.
