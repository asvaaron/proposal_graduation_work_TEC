...
\item Investigate the robustness of the modified Visual Transformer model under adversarial and challenging image conditions, including noise and data perturbations such as occlusions, illumination variations, and subtle facial deformations, as well as fairness-related aspects involving demographic biases (e.g., age, gender, and ethnicity), using the RAF-DB data set to represent in-the-wild conditions.
	
\item Explore how the new MLP head architecture improve the model's resilience to a \gls{in-the-wild} data set by employing standard \gls{FER} evaluation metrics like accuracy, f1-score, recall, confusion matrices and loss function curves. 
