...
Thought the work developed in the thesis, a new version of the head is presented as an opportunity to explore on how the final classification can help improve model predictability or, also achieve better results on specific classes or challenging classes. The head was integrated into the code  using the base of hyperparameters  that helps run systematic experiments and changing different sizes of the model. 
