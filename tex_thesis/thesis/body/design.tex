...
This chapter describes the experimental design adopted in this research, including the algorithm,  architectural decisions, evaluation criteria, and constraints that guided the development and assessment used to test the hypotesis. The design is structured to ensure reproducibility, statistical validity, and relevance to real-world Facial Expression Recognition (FER) scenarios.
