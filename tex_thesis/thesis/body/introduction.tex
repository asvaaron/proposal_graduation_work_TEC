...
Finally, \nameref{chapter:conclusions-fw} shows all the obtained conclusions and remarks from the research presented in this document as future work that can be perform in the future. \nameref{chapter:appendixes} includes supplementary materials and a References section citing relevant sources. An additional section glossary is added with the technical terms used during the development of the thesis. 
