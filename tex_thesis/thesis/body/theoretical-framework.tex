...
\caption{Real-world Affective Faces Database (RAF-DB), a dataset for facial expression \\ \textbf{Source:} Reliable Crowdsourcing and Deep Locality-Preserving Learning for Expression Recognition in the Wild  \cite{li_reliable_2017}}
\label{fig:RAF-DB}
\end{figure}
