...
The models were trained in a controlled environment, where the only variations between runs are the levels of the factors being tested. This allowed for a rigorous comparison of how  model size and head modifications influence the transformer's performance in \gls{FER} tasks.
