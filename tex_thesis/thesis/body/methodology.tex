...
Table \ref{tab:factors-and-levels} summarizes the factors and levels used on all of the experiments. 


\begin{table}[H]
\centering
\caption{Experimental Factors and Levels}
\label{tab:factors-and-levels}
\begin{tabular}{lll}
\toprule
...
The standard or top-1 accuracy was used as the main metric for reviewing performance and robustness comparison between models. The metric corresponds to a simple calculation taking the correctly classified samples and dividing it by the total number of samples. Equation \ref{eq:accurracy} shows how accuracy is calculated. 
...
\begin{figure}[H]
\centering
   \includegraphics[width=0.90\textwidth]{../images/training-validation-accurracy-example.png}
